...
- `skills/team-lead/SKILL.md` — Phase 1 intake questions, Phase 5 plan-revision questions, any mid-run clarification
- `skills/idea-refine/SKILL.md` — Phase 1 divergent questions (the skill's own text describes "3–5 questions," but this protocol enforces one-per-message when invoked from team-lead)
